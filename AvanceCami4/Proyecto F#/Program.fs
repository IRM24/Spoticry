...
let obtenerCancionesDePlaylist (playlists: Dictionary<string, List<string>>) (nombrePlaylist: string) : List<string> option =
    match playlists.TryGetValue(nombrePlaylist) with
    | true, canciones ->
        Some canciones
    | false, _ ->
        None
                ...
                | "b" ->
                    ...
                    | Some canciones -> 
                        ...
                        for song in canciones do
                            ...
                            if contador = 0 then
                                playSongPlaylist stream cancionS
                                client.Close()
                                contador <- contador + 1
